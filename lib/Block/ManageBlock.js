...
!function() {
	...
	Brickrouge.Widget.ActionBarUpdateTree = new Class({
	...
	Brickrouge.register('ActionBarUpdateTree', function (element, options) {

		return new Brickrouge.Widget.ActionBarUpdateTree(element, options)
